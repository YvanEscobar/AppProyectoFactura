...
public class MainEscaneo extends AppCompatActivity {
    ...
    Button mButtonVal, mButtonEscanear, mButtonLimpiar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_escaneo_fragment);
        ...
        mButtonEscanear = findViewById(R.id.buttonEscanear);
        mButtonLimpiar = findViewById(R.id.buttonLimpiar);

        mButtonVal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                documentValidation ("https://proyectoinformatico03.000webhostapp.com/validacion.php?nro_ruc="+mResultEt.getText()+"&nro_doc="+mResultEtFact.getText()+"");
            }
        });

        mButtonEscanear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
